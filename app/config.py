...
class Settings:
    endpoint: str = os.getenv(
        "AZURE_OPENAI_ENDPOINT", "https://giladkatz-foundry-exter-resource.cognitiveservices.azure.com"
    )
    api_key: str = os.getenv("AZURE_OPENAI_API_KEY", "")
    api_version: str = os.getenv("AZURE_OPENAI_API_VERSION", "2024-10-21")

    # BUG (seeded for SRE Agent demo):
    # The production Foundry resource (giladkatz-foundry-exter-resource) exposes
    # a deployment named "gpt-4o".
